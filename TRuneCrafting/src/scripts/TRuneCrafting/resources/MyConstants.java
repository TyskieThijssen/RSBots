...
//    public static final Tile[] VARROCK_BANK_EARTH_ALTAR = {new Tile(3253, 3420, 0), new Tile(3253, 3424, 0), new Tile(3256, 3427, 0), new Tile(3259, 3428, 0), new Tile(3262, 3428, 0), new Tile(3265, 3428, 0), new Tile(3268, 3428, 0), new Tile(3271, 3428, 0), new Tile(3274, 3428, 0), new Tile(3277, 3428, 0), new Tile(3280, 3428, 0), new Tile(3283, 3430, 0), new Tile(3284, 3433, 0), new Tile(3284, 3436, 0), new Tile(3284, 3439, 0), new Tile(3284, 3442, 0), new Tile(3284, 3445, 0), new Tile(3284, 3448, 0), new Tile(3284, 3451, 0), new Tile(3284, 3454, 0), new Tile(3284, 3457, 0), new Tile(3284, 3460, 0), new Tile(3286, 3463, 0), new Tile(3289, 3466, 0), new Tile(3292, 3468, 0), new Tile(3294, 3471, 0), new Tile(3296, 3474, 0), new Tile(3299, 3477, 0), new Tile(3301, 3481, 0), new Tile(3304, 3482, 0), new Tile(3306, 3479, 0), new Tile(3306, 3476, 0)};
